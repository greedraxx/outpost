    ...
    <footer className="bg-background border-t border-border/20 mt-20">
      <div className="max-w-[1200px] mx-auto px-8 py-16">
        <div className="flex items-start justify-between mb-16">
          <div>
            <h3 className="text-[56px] font-bold mb-3 leading-none text-foreground">OUT POST</h3>
            <p className="text-[14px] text-muted-foreground max-w-[220px] leading-relaxed">
              Blog about ai, tech, agent.
            </p>
          </div>
          <div className="flex items-center gap-3">
            <button 
              className="w-11 h-11 rounded-full bg-accent hover:bg-accent/90 flex items-center justify-center transition-all duration-300"
              aria-label="Twitter"
            >
        ...
        <div className="flex flex-wrap gap-10 text-[13px] mb-10 pb-10 border-b border-border/20">
